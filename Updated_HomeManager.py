...
def on_message(client, userdata, msg):
    if msg.topic == "sending/sensorData":
        ...
        values = (
            context_message["user"], context_message["temp"], context_message["gasDetect"],
            context_message["fireDetect"], context_message["light"], context_message["humidity"],
            context_message["pressure"], context_message["month"], context_message["hour"],
            context_message["day"], context_message["year"]
        )
        insert_query = """
